...
$classes = $db->fetchAll("SELECT c.*, u.first_name, u.last_name FROM classes c LEFT JOIN users u ON c.teacher_id = u.id WHERE c.is_active = 1 ORDER BY c.name");
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-header h1 { font-size: 1.75rem; color: #1e293b; margin-bottom: 0.5rem; }
        ...
        .stat-card.teachers .stat-icon { background: #dbeafe; color: #1e40af; }
        .stat-card.students .stat-icon { background: #dcfce7; color: #166534; }
        .stat-card.parents .stat-icon { background: #fce7f3; color: #9d174d; }
        .stat-card.classes .stat-icon { background: #fef3c7; color: #92400e; }
        .stat-card.pending .stat-icon { background: #fee2e2; color: #991b1b; }
        ...
        .tab:hover { background: #f1f5f9; color: #374151; }
        ...
        .badge-teacher { background: #fce7f3; color: #9d174d; }
