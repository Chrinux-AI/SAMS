...
// Session security
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'forum-moderator') {
...
try {
    ...
    $manager->moderateAction($input['report_id'], $input['action']);
    echo json_encode(['success' => true, 'message' => 'Post moderated']);
