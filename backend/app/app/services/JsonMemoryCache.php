...
class JsonMemoryCache
{
    ...
    /**
     * Serialize cache data for persistence (if needed)
     */
    ...
    /**
     * Unserialize cache data (if needed)
     */
    public function unserialize($data)
    {
        ...
        if (isset($data['statistics'])) {
            $this->hitCount = $data['statistics']['hit_count'] ?? 0;
            $this->missCount = $data['statistics']['miss_count'] ?? 0;
        }
    ...
    public function debugInfo()
    {
        ...
        $info = [
            ...
            'hit_count' => $this->hitCount,
            'miss_count' => $this->missCount,
            'hit_rate' => ($this->hitCount + $this->missCount) > 0 ? round(($this->hitCount / ($this->hitCount + $this->missCount)) * 100, 2) : 0,
    ...
    public function getMetadata($key)
    {
        ...
        return [
            ...
            'time_remaining' => max(0, $item['expires_at'] - time())
        ];
    }
    ...
    {
        return round($this->getMemoryUsage() / 1024 / 1024, 2);
    }
