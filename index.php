...
$publicPages = [
  'biometric_core' => [
    ...
    'summary' => 'Biometric identity verification for secure attendance, reduced proxy check-ins, and institution-grade access control.',
    'highlights' => [
      'Fingerprint-ready attendance flows for real-time check-in verification',
      'Stronger identity confidence for sensitive student and staff actions',
      'Built to support role-aware logging, alerts, and audit-friendly records'
    ]
  ],
  'role_portals' => [
    'section' => 'Product',
    'title' => 'Role Portals',
    'summary' => 'Dedicated dashboards and workflows for admins, teachers, students, parents, accountants, librarians, and transport operations.',
    'highlights' => [
      'Each role sees only the pages and actions relevant to that role',
      'Tenant-safe navigation across school-scoped dashboards',
      'Clear operational separation between leadership, academic, and support teams'
    ]
  ],
  'sams_public_ai' => [
    'section' => 'Product',
    'title' => 'SAMS Public AI',
    'summary' => 'Public-facing assistant and smart guidance layer designed to help visitors, schools, and platform users navigate the system faster.',
    'highlights' => [
      'Supports public discovery and guided navigation on the landing experience',
      'Can surface school-first onboarding paths and role entry points',
      'Extensible for advisory workflows without bypassing human approval'
    ]
  ],
  'analytics_engine' => [
    'section' => 'Product',
    'title' => 'Analytics Engine',
    'summary' => 'Operational analytics for attendance, class activity, academic monitoring, and school-wide performance visibility.',
    'highlights' => [
      'Attendance and daily impact metrics in one reporting layer',
      'Supports merit tracking, role dashboards, and operational review',
      'Designed for future expansion into deeper academic and finance insights'
    ]
  ],
  'documentation' => [
    'section' => 'Resources',
    'title' => 'Documentation',
    'summary' => 'Core project documentation for the current main project and merged operating model.',
    'highlights' => [
      'Project overview and merge direction live inside the attendance project',
      'Public pages can point schools and operators to the current documentation set',
      'The main project remains attendance, with donor folders as source material only'
    ]
  ],
  'api_reference' => [
    'section' => 'Resources',
    'title' => 'API Reference',
    'summary' => 'Reference surface for the merged backend APIs covering merit, school lifecycle, attendance, and role operations.',
    'highlights' => [
      'Merit and lifecycle APIs now live in the main attendance project',
      'Designed for tenant-safe school operations and ledger-backed point flows',
      'Extensible for future integrations and reporting surfaces'
    ]
  ],
  'school_setup' => [
    'section' => 'Resources',
    'title' => 'School Setup',
    'summary' => 'School-first onboarding path for creating the institution first, then adding managed users under that tenant.',
    'highlights' => [
      'A school is registered before operational user activity begins',
      'Admins gain access first and can invite staff through managed onboarding',
      'Students and parents remain inside an existing school context'
    ]
  ],
  'phase_status' => [
    'section' => 'Resources',
    'title' => 'Phase Status',
    'summary' => 'Current implementation status of the main attendance project after donor consolidation from attendance-2 and SAMS 2.',
    'highlights' => [
      'Merged merit, invite, wallet, and school-first flows are now in attendance',
      'Key attendance, behavior, and grade paths are already wired into merit events',
      'The current phase is ready for workflow testing and next-stage hardening'
    ]
  ],
  'about_us' => [
    'section' => 'Company',
    'title' => 'About Us',
    'summary' => 'Academic Sentinel Systems is focused on resilient, secure, role-aware software for modern educational institutions.',
    'highlights' => [
      'Built around school-first onboarding and operational clarity',
      'Designed to support Nigerian school structures and multi-school tenancy',
      'Focused on reliability, auditability, and practical day-to-day use'
    ]
  ],
  'security' => [
    'section' => 'Company',
    'title' => 'Security',
    'summary' => 'Security posture built around role-aware access, tenant isolation, auditable actions, and controlled school-managed entry.',
    'highlights' => [
      'Login and navigation are role-aware and tenant-scoped',
      'Invite-based staff entry reduces uncontrolled account sprawl',
      'Merit, wallet, and enforcement changes are designed to stay auditable'
    ]
  ],
  'privacy_policy' => [
    'section' => 'Company',
    'title' => 'Privacy Policy',
    'summary' => 'Privacy direction for student, staff, parent, and school data in a school-scoped multi-tenant platform.',
    'highlights' => [
      'Each school operates within its own tenant-scoped data boundary',
      'Operational pages are role-restricted and session-controlled',
      'Sensitive academic and identity data stays inside controlled institutional workflows'
    ]
  ],
  'contact' => [
    'section' => 'Company',
    'title' => 'Contact',
    'summary' => 'Contact and onboarding entry points for institutions evaluating or deploying the School Attendance System.',
    'highlights' => [
      'Use school-first registration for new institutional onboarding',
      'Use managed invite entry for school-issued staff onboarding',
      'Use the main portal login for already provisioned users'
    ]
  ]
];

$publicPage = strtolower(trim((string) ($_GET['page'] ?? '')));
$publicPage = preg_replace('/[^a-z0-9_]/', '', $publicPage);
$activePublicPage = $publicPages[$publicPage] ?? null;
?>
<!DOCTYPE html>
...
<body class="font-body mesh-bg overflow-x-hidden">
  ...
  <main class="w-full">
    <?php if ($activePublicPage): ?>
      <section class="relative pt-40 pb-20 px-6 max-w-[1200px] mx-auto min-h-[70vh] flex items-center">
        <!-- Clean background structure -->
        <div class="w-full grid lg:grid-cols-12 gap-8 items-start">
          <div class="lg:col-span-7 reveal active">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/10 bg-primary/5 text-primary text-xs font-label font-bold tracking-widest uppercase">
              <span class="material-symbols-outlined text-[14px]">article</span>
              <?php echo htmlspecialchars($activePublicPage['section']); ?>
            </div>
            <h1 class="mt-6 text-5xl md:text-6xl font-headline font-extrabold text-on-surface tracking-tight leading-[1.05]">
              <?php echo htmlspecialchars($activePublicPage['title']); ?>
            </h1>
            <p class="mt-6 text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-2xl">
              <?php echo htmlspecialchars($activePublicPage['summary']); ?>
            </p>
            <div class="mt-10 flex flex-col sm:flex-row gap-4">
              <a href="index.php" class="px-7 py-4 premium-gradient text-white font-headline font-bold rounded-2xl shadow-xl shadow-primary/20 flex items-center justify-center gap-2">
                <span class="material-symbols-outlined">arrow_back</span>
                Back to Home
              </a>
              <a href="login.php" class="px-7 py-4 bg-white text-primary border border-outline-variant/40 font-headline font-bold rounded-2xl flex items-center justify-center gap-2">
                <span class="material-symbols-outlined">login</span>
                Open Portal
              </a>
            </div>
          </div>
          <div class="lg:col-span-5 reveal-right active">
            <div class="glass-card rounded-[2rem] p-7 bg-white/85 border border-white/70">
              <h2 class="text-xl font-headline font-extrabold text-on-surface mb-5">Page Highlights</h2>
              <div class="space-y-4">
                <?php foreach ($activePublicPage['highlights'] as $highlight): ?>
                  <div class="flex items-start gap-3 p-4 rounded-2xl bg-surface-container-low border border-outline/30">
                    <span class="material-symbols-outlined text-primary mt-0.5">check_circle</span>
                    <p class="text-sm text-on-surface-variant leading-relaxed font-medium"><?php echo htmlspecialchars($highlight); ?></p>
                  </div>
                <?php endforeach; ?>
              </div>
            </div>
    ...
    <?php else: ?>
      ...
      <section class="relative pt-40 pb-20 px-6 max-w-[1400px] mx-auto min-h-[90vh] flex flex-col justify-center overflow-hidden">
        ...
        <!-- Removed floating blurred backgrounds for professional look -->
      ...
      <section class="py-20 px-6 bg-white border-t border-outline/20">
        <div class="max-w-[1280px] mx-auto reveal">
          <div class="rounded-[2rem] premium-gradient text-white overflow-hidden shadow-[0_30px_80px_rgba(0,7,103,0.18)]">
            <div class="grid lg:grid-cols-12 gap-10 px-8 py-10 md:px-12 md:py-14">
              <div class="lg:col-span-7">
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/10 text-[11px] font-label font-bold tracking-[0.2em] uppercase">
                  <span class="material-symbols-outlined text-sm">rocket_launch</span>
                  School-First Rollout
                </div>
                <h2 class="mt-6 text-4xl md:text-5xl font-headline font-extrabold tracking-tight leading-tight">
                  One platform for registration, attendance, roles, analytics, and school operations.
                </h2>
                <p class="mt-5 text-base md:text-lg text-white/80 max-w-2xl leading-relaxed">
                  Launch your institution with managed onboarding, keep staff access invite-based, and run the entire attendance ecosystem from a single secure workspace.
                </p>
              </div>
              <div class="lg:col-span-5 flex flex-col justify-center gap-4">
                <a href="school-register.php" class="w-full px-6 py-4 rounded-2xl bg-white text-primary font-headline font-bold text-base flex items-center justify-center gap-2 hover:bg-slate-100 transition-colors">
                  <span class="material-symbols-outlined">domain_add</span>
                  Register Your School
                </a>
                <a href="invite-register.php" class="w-full px-6 py-4 rounded-2xl border border-white/20 bg-white/10 text-white font-headline font-bold text-base flex items-center justify-center gap-2 hover:bg-white/15 transition-colors">
                  <span class="material-symbols-outlined">mail_lock</span>
                  Redeem School Invite
                </a>
                <a href="login.php" class="w-full px-6 py-4 rounded-2xl border border-white/20 bg-transparent text-white font-headline font-bold text-base flex items-center justify-center gap-2 hover:bg-white/10 transition-colors">
                  <span class="material-symbols-outlined">login</span>
    ...
    <div class="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-indigo-200/70 font-medium">
          <li><a href="index.php?page=biometric_core" class="hover:text-white transition-colors">Biometric Core</a></li>
          <li><a href="index.php?page=role_portals" class="hover:text-white transition-colors">Role Portals</a></li>
          <li><a href="index.php?page=sams_public_ai" class="hover:text-white transition-colors">SAMS Public AI</a></li>
          <li><a href="index.php?page=analytics_engine" class="hover:text-white transition-colors">Analytics Engine</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-indigo-200/70 font-medium">
          <li><a href="index.php?page=documentation" class="hover:text-white transition-colors">Documentation</a></li>
          <li><a href="index.php?page=api_reference" class="hover:text-white transition-colors">API Reference</a></li>
          <li><a href="index.php?page=school_setup" class="hover:text-white transition-colors">School Setup</a></li>
          <li><a href="index.php?page=phase_status" class="hover:text-white transition-colors">Phase Status</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-4 text-sm text-indigo-200/70 font-medium">
          <li><a href="index.php?page=about_us" class="hover:text-white transition-colors">About Us</a></li>
          <li><a href="index.php?page=security" class="hover:text-white transition-colors">Security</a></li>
          <li><a href="index.php?page=privacy_policy" class="hover:text-white transition-colors">Privacy Policy</a></li>
          <li><a href="index.php?page=contact" class="hover:text-white transition-colors">Contact</a></li>
        </ul>
      </div>
    </div>
