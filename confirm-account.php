...
<body class="bg-background font-body text-on-surface flex flex-col min-h-screen">
  ...
  <main class="relative z-10 flex-grow flex items-center justify-center p-6 mt-12 mb-12">
    <div class="w-full max-w-[480px]">
      ...
      <!-- Center Branding -->
      <div class="text-center mb-8 animate-stagger">
      ...
      <!-- Main Card -->
      <div class="glass-card rounded-2xl p-8 animate-stagger delay-100 relative overflow-hidden">
        <!-- inner glow edge -->
        <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-primary/30 to-transparent"></div>
        
        <div class="mb-8 text-center animate-stagger delay-100">
          ...
          <form method="POST" class="space-y-6 animate-stagger delay-200">
            ...
            <?php if ($user_email === ''): ?>
              <div class="space-y-2">
                ...
                <div class="relative">
                  ...
                  <input class="w-full bg-surface-container-low border-none rounded-lg py-3.5 pl-12 pr-4 text-sm input-glow transition-all text-on-surface" id="email_input" name="email" type="email" placeholder="name@institution.edu" required value="<?php echo htmlspecialchars($user_email); ?>">
                </div>
              </div>
            <?php else: ?>
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-between gap-2">
                <?php for ($i = 0; $i < 6; $i++): ?>
                  <input type="text" maxlength="1" inputmode="numeric" required class="w-12 h-14 text-center text-xl font-bold bg-surface-container-low border-none rounded-lg input-glow transition-all font-mono otp-digit text-on-surface">
                <?php endfor; ?>
              </div>
            </div>
            ...
            <div class="space-y-2 pt-4 border-t border-outline-variant/10">
              ...
              <div class="relative">
                <input class="w-full bg-surface-container-low border-none rounded-lg py-3.5 px-4 pr-12 text-sm input-glow transition-all text-on-surface" id="password" name="password" type="password" required minlength="<?php echo PASSWORD_MIN_LENGTH; ?>">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input class="w-full bg-surface-container-low border-none rounded-lg py-3.5 px-4 pr-12 text-sm input-glow transition-all text-on-surface" id="confirm_password" name="confirm_password" type="password" required minlength="<?php echo PASSWORD_MIN_LENGTH; ?>">
            ...
            <button type="submit" class="premium-gradient w-full py-4 px-6 rounded-lg text-white font-headline font-bold text-sm tracking-tight shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group mt-6">
        ...
        <div class="mt-8 pt-6 border-t border-outline-variant/10 text-center animate-stagger delay-300">
      ...
      <div class="mt-8 p-4 bg-blue-50/50 backdrop-blur-sm rounded-xl text-xs text-blue-900 flex items-start gap-3 border border-blue-100 animate-stagger delay-400 shadow-sm">
