...
<body class="bg-background font-body text-on-background min-h-screen flex flex-col items-center justify-center p-4">
  ...
  <div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none opacity-40">
    ...
    <div class="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] rounded-full bg-secondary-container blur-[100px]"></div>
  </div>
  ...
  <main class="w-full max-w-md">
    ...
    <div class="flex flex-col items-center mb-10 space-y-2">
      <div class="flex items-center space-y-1 flex-col">
        <span class="material-symbols-outlined text-primary text-5xl mb-2">school</span>
        <h1 class="font-headline font-extrabold text-4xl tracking-tight text-on-primary-fixed"><?php echo APP_NAME; ?></h1>
        <p class="font-headline text-on-surface-variant text-sm tracking-[0.2em] uppercase font-medium">Academic Sentinel</p>
      </div>
    </div>

    <!-- Login Card -->
    <div class="bg-surface-container-lowest rounded-xl shadow-tint p-8 ghost-border">
      <!-- Logo -->
      ...
      <form method="POST" action="" class="space-y-6">
        ...
        <div class="space-y-4">
          <div class="space-y-2">
            ...
            <input class="w-full px-4 py-3 bg-surface-container-low border-none rounded-lg focus:ring-2 focus:ring-surface-tint text-on-surface text-sm transition-all duration-200" id="email" name="email" placeholder="e.g. admin@sams.edu" type="email" required autocomplete="email">
          </div>
          <div class="space-y-2">
            <div class="flex justify-between items-center">
              ...
              <a class="text-xs text-primary font-medium hover:underline" href="forgot-password.php">Forgot password?</a>
            </div>
            <div class="relative">
              <input class="w-full px-4 py-3 bg-surface-container-low border-none rounded-lg focus:ring-2 focus:ring-surface-tint text-on-surface text-sm transition-all duration-200 pr-12" id="password" name="password" placeholder="••••••••" type="password" required>
        ...
        <!-- Primary Action -->
        <button class="w-full bg-primary-gradient text-on-primary py-3.5 rounded-lg font-bold text-sm tracking-wide shadow-lg hover:shadow-primary-fixed/20 transition-all duration-300 transform active:scale-[0.98]" type="submit" name="login">
          Login to Sentinel
        </button>
      </form>
      ...
      <div class="relative my-8">
        ...
        <div class="relative flex justify-center text-xs uppercase">
          <span class="bg-surface-container-lowest px-4 text-on-surface-variant font-label tracking-widest">or continue with</span>
        </div>
      </div>

      <!-- Biometric Login -->
      <button type="button" onclick="performBiometricLogin()" class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-surface-container-low border-none rounded-lg text-on-surface-variant text-sm font-medium hover:bg-surface-container hover:text-on-surface transition-colors duration-200">
      ...
      <footer class="mt-8 pt-6 border-t border-outline-variant/10 text-center">
        <p class="text-on-surface-variant text-sm">
          ...
          <a class="text-primary font-bold hover:underline ml-1" href="register.php">Register</a>
        </p>
      </footer>
    </div>
