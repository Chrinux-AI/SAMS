...
class MemoryCache
{
    ...
    public function cacheActiveClasses($tenantId)
    {
        ...
        try {
            $classes = db()->fetchAll("
                SELECT c.id, c.class_name, c.class_code, c.class_teacher_id,
                ...
                GROUP BY c.id, c.class_name, c.class_code, c.class_teacher_id, u.first_name, u.last_name
    ...
    private function getTeacherDashboardSummary($teacherId, $tenantId)
    {
        ...
        $attendance = db()->fetchOne("
            ...
            WHERE c.class_teacher_id = ? AND DATE(ar.check_in_time) = ? AND c.tenant_id = ?
