...
<body class="bg-background font-body text-on-background antialiased min-h-screen flex flex-col">
  <!-- Top Navigation Bar -->
  <header class="bg-white/80 backdrop-blur-md text-primary font-headline text-sm font-medium tracking-tight fixed top-0 z-50 flex justify-between items-center w-full px-6 py-3 shadow-[0_20px_40px_rgba(0,7,103,0.06)]">
      ...
      <div class="md:col-span-8 p-10 md:p-14 bg-surface-container-lowest">
        ...
        <div class="flex justify-center mb-8">
          <picture>
            ...
            <img src="assets/logo/logo5.png" alt="SAMS Logo" class="h-14 w-auto rounded-2xl object-contain" style="max-width: 160px;">
          </picture>
        </div>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-3 gap-3">
                ...
                $roles = [
                  ...
                  'teacher' => ['icon' => 'person', 'label' => 'Teacher'],
                ];
