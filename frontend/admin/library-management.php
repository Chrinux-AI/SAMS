    ...
    <div class="library-container">
        ...
        <div class="content-grid">
            ...
            <div class="panel">
                ...
                <!-- Tabs -->
                <div class="tabs">
                    <button class="tab active" onclick="showTab(event, 'books')">Books</button>
                    <button class="tab" onclick="showTab(event, 'categories')">Categories</button>
                    <button class="tab" onclick="showTab(event, 'members')">Members</button>
                </div>
