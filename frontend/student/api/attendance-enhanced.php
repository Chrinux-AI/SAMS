...
function handleQRCheckIn()
{
    ...
    try {
        // Validate QR code
        $stmt = $pdo->prepare("
            SELECT qc.*, c.class_name as class_name, c.class_code
...
function getCorrectionRequests()
{
    ...
    try {
        $sql = "
            SELECT ac.*, c.class_name as class_name, c.class_code,
...
function getAttendanceAnalytics()
{
    ...
    try {
        ...
        $stmt = $pdo->prepare("
            SELECT
                c.id, c.class_name as class_name, c.class_code,
                COUNT(*) as total,
...
function getClassReminders()
{
    ...
    try {
        $stmt = $pdo->prepare("
            SELECT cr.*, c.class_name as class_name, c.class_code, c.start_time
...
function getAttendanceHistory()
{
    ...
    try {
        $sql = "
            SELECT ar.*, c.class_name as class_name, c.class_code, c.room_number,
