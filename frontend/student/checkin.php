...
<head>
    ...
    <style>
        .checkin-container { min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
        .checkin-box { max-width: 500px; width: 100%; }
        .cyber-clock { background: #fff; border: 1px solid #E5E7EB; border-radius: 16px; padding: 30px; text-align: center; margin-bottom: 24px; box-shadow: 0 4px 24px rgba(0,0,0,0.04); }
        .clock-time { font-family: 'Courier New', monospace; font-size: 48px; font-weight: 700; color: #4F46E5; margin-bottom: 8px; }
        .clock-date { font-size: 16px; color: #6B7280; }
        .class-grid { display: grid; gap: 12px; margin-top: 20px; }
        .class-card-checkin { background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; padding: 20px; transition: all 0.3s; box-shadow: 0 2px 8px rgba(0,0,0,0.03); }
        .class-card-checkin:hover { border-color: #4F46E5; transform: translateY(-2px); box-shadow: 0 4px 16px rgba(79,70,229,0.1); }
        .class-card-checkin.checked-in { border-color: #10B981; background: #F0FDF4; }
        .class-info { margin-bottom: 15px; }
        .class-name { font-size: 16px; font-weight: 700; color: #111827; margin-bottom: 4px; }
        .class-code { font-size: 13px; color: #6B7280; }
        .checkin-btn-class { width: 100%; padding: 12px; background: #4F46E5; border: none; border-radius: 8px; color: #fff; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: inherit; font-size: 0.9rem; }
        .checkin-btn-class:hover { background: #4338CA; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(79,70,229,0.3); }
        .checkin-btn-class:disabled { background: #E5E7EB; color: #9CA3AF; cursor: not-allowed; transform: none; box-shadow: none; }
        .student-id-input { font-family: 'Courier New', monospace; font-size: 24px; text-align: center; letter-spacing: 2px; }
    </style>
</head>
