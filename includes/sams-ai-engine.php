...
class SAMS_AI_Engine
{
    ...
    private function getDashboardUrl()
    {
        switch ($this->userRole) {
            case 'admin':
                return '/attendance/admin/dashboard.php';
            case 'teacher':
                return '/attendance/teacher/dashboard.php';
            case 'parent':
                return '/attendance/parent/dashboard.php';
            default:
                return '/attendance/student/dashboard.php';
        }
    }
    ...
    private function getScheduleUrl()
    {
        switch ($this->userRole) {
            case 'teacher':
                return '/attendance/teacher/schedule.php';
            case 'parent':
                return '/attendance/parent/my-meetings.php';
            default:
                return '/attendance/student/schedule.php';
        }
    }
    ...
    private function getGradesUrl()
    {
        switch ($this->userRole) {
            case 'parent':
                return '/attendance/parent/grades.php';
            case 'teacher':
                return '/attendance/teacher/reports.php';
            default:
                return '/attendance/student/grades.php';
        }
    }
